...
@ComponentScan(basePackages = {"com.intheeast.service", "com.intheeast.dao","com.intheeast.init"})
...
public class AppConfig{
    ...
    public JavaMailSenderImpl javaMailSender() {
     ...
     // 구글 SMTP 서버 설정
        ...
        // 구글 이메일 계정 정보 입력
        mailSender.setUsername("tjrwn1234562@gmail.com");  // 구글 이메일 계정
        mailSender.setPassword("vzgi csqr dxbf nnmn");    // 앱 비밀번호 (구글 계정에서 생성)
...
//        props.put("mail.smtp.ssl.trust", "smtp.gmail.com");  // SSL 신뢰 설정 (TLS 사용하는 경우 불필요)
    ...
    public SimpleMailMessage simpleMailMessage() {
        ...
        message.setFrom("swseokitec@gmail.com");  // 기본 발신자 설정
