...
@Controller
@RequestMapping("/posts") // Spring Framework의 애노테이션으로, 해당 컨트롤러가 특정 URL 요청을 처리하도록 매핑하는 역할을 합니다.
public class PostController {
    ...
    // 게시글 상세 조회 및 댓글 표시  // /post/id? @RequestMapping("/posts") 선언을 했으므로 /posts/{id} 임
    @GetMapping("/{id}")
